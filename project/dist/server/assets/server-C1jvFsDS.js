...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-5nafv5Uc.js");
...
const manifest = {
  "9aeb2a0838b5c4f618356f26ce7663cf7ad69c8fc86148f8280b7452144301d6": {
    functionName: "subscribeEmail_createServerFn_handler",
    importer: () => import("./subscribers.functions-CVgOpBe7.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-I3TUVc4j.js").then((n2) => n2.r),
    import("./start-BG0k_nWP.js"),
...
export { H, v, b, f, $, q, E, W, D, c, B, Y, M, k, A, n, m, N, x, Z, F, w, y, _ }